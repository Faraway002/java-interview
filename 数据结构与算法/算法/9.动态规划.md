...
### 力扣 509 斐波那契数 & 剑指 Offer 10-Ⅰ. 斐波那契数列

![image-20220409092734696](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409092734696.png)
...
1. 暴力解法。由于斐波那契数列定义上就是递归的，因此可以递归解决：
   ...
   ![image-20220409092908312](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409092908312.png)
...
![img](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/fib.png)
...
### 力扣 70 爬楼梯 & 剑指 Offer 10-Ⅱ. 青蛙跳台阶问题

![image-20220628110633999](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220628110633999.png)
...
![image-20220502143849441](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220502143849441.png)
...
![image-20220502143957360](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220502143957360.png)
...
本题已经体现了动态规划的核心步骤，之后的题目都将遵循动态规划四部曲。

力扣 

### 力扣 62 不同路径

![image-20220505141722060](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220505141722060.png)
...
![image-20220508101450811](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220508101450811.png)
...
![image-20220508105149746](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220508105149746.png)

本题乍一看是一个数学题（事实上也的确如此）没什么头绪，如果硬要写的话也可以暴力，但是复杂度太高了，涉及到大量重复计算，因此首选动态规划解法。

对于的正整数 $n$，当 $n >= 2$ 时，可以拆分成至少两个正整数的和。令 $k$ 是拆分出的第一个正整数，则剩下的部分是 $n-k$，$n−k$ 可以不继续拆分，或者继续拆分成至少两个正整数的和，这也是我们状态转移的依据。

四部曲：

1. 明确 base case：从本题定义上看，0 和 1 不能拆分，2 开始才可以拆分为 2 个 1，因此这就是 base case。
2. 明确状态：本题状态就是正整数 n。
3. 明确选择：我们刚刚也说过了，当 $n >= 2$ 时，可以拆分成至少两个正整数的和。令 $k$ 是拆分出的第一个正整数，则剩下的部分是 $n-k$，$n−k$ 可以不继续拆分，或者继续拆分成至少两个正整数的和。这个时候，我们选择其中最大的那一个即可。
...
![image-20220503100913228](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220503100913228.png)
...
![image-20220416104223407](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416104223407.png)
...
![](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220501112112411.png)
...
![image-20220502094016153](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220502094016153.png)
...
![image-20220502102704788](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220502102704788.png)
...
![image-20220416105034161](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416105034161.png)
...
![img](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/poker1.jpeg)
...
![img](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/poker2.jpeg)
...
![image-20220502104307322](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220502104307322.png)
...
![image-20220416111112969](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416111112969.png)
...
1. 把该问题抽象为 LIS 问题。
   ...
   <img src="https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416111814327.png" alt="image-20220416111814327" style="zoom: 67%;" />

   那么我们只要找 h 维度的最长递增子序列，就可以得到能够套娃的信封。

   <img src="https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416112142972.png" alt="image-20220416112142972" style="zoom:67%;" />
...
![image-20220416142221453](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416142221453.png)
...
![image-20220503094358145](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220503094358145.png)
...
![image-20220503094919567](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220503094919567.png)
...
![image-20220504092344902](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220504092344902.png)
...
![image-20220504093946819](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220504093946819.png)
...
![image-20220504105114729](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220504105114729.png)



### 力扣 72 编辑距离

![image-20220416142028482](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416142028482.png)
...
![image-20220508100843552](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220508100843552.png)
...
![image-20220629114502910](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220629114502910.png)
...
![image-20220504102153013](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220504102153013.png)
...
![image-20220508102942317](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220508102942317.png)

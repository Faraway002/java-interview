...
![image-20220406111300750](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220406111300750.png)

![image-20220417135818099](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220417135818099.png)

本题要求不使用额外空间，因此可以使用快慢指针。

可以让 fast 指针去前面探路，**slow 指针维护不重复的数组项**，当发现 slow 和 fast 不相同时，slow++，然后就把 fast 指针的值赋给 slow，这样 fast 到最后时，arr[0 ~ slow] 数组就是一个无重复元素的数组。
...
![image-20220406114128651](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220406114128651.png)

![image-20220417135853417](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220417135853417.png)
...
![image-20220406114433802](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220406114433802.png)
...
![image-20220417133904332](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220417133904332.png)
...
![image-20220629164222296](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220629164222296.png)
...
![image-20220421103832660](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220421103832660.png)
...
二分查找是一个重要的是思想，通过一前一后两个指针来缩短搜索所需要的时间。

##### 力扣 704 二分查找

![image-20220407104208003](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220407104208003.png)
...
![image-20220407120306152](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220407120306152.png)
...
* 精髓在于 `nums[mid] == target` 时，`right = mid - 1` 这一步处理。
  ...
  这表示虽然找到了该元素，但是该元素有可能出现在众多相同元素的中间位置，因此还要往左边收缩找到最左边的位置。
...
##### 力扣 240 搜索二维矩阵Ⅱ & 剑指 Offer 04.二维数组中的查找

![image-20220623081249978](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220623081249978.png)

本题是把二分搜索拓展到了二维数组，我们可以以左下角或右上角为支点。
...
![image-20220409131920440](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409131920440.png)
...
![image-20220417151546831](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220417151546831.png)
...
![image-20220417152437461](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220417152437461.png)
...
![image-20220409133250160](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409133250160.png)
...
![image-20220409135430714](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409135430714.png)
...
![image-20220409134141613](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409134141613.png)

本题和上面的有所不同，本题没有特别指定的目标，仅要求不重复，因此从头开始滑，碰到不重复的就右滑，碰到重复的就左滑直到重复的字符被移除：
...
![image-20220412094703867](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220412094703867.png)
...
![image-20220412125204839](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220412125204839.png)
...
![image-20220408091720443](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408091720443.png)
...
![image-20220408091905934](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408091905934.png)
...
![image-20220408093025108](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408093025108.png)
...
![image-20220408094010507](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408094010507.png)
...
![image-20220408094105795](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408094105795.png)
...
![image-20220408105559025](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408105559025.png)

本题要实现一个按照权重的随机算法，即 w[i] 高的，选中 i 的概率也要高。

假设给你输入的权重数组是 `w = [1,3,2,1]`，我们想让概率符合权重，那么可以抽象一下，根据权重画出这么一条彩色的线段：

![image-20220408110532798](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408110532798.png)
...
![image-20220408102030505](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408102030505.png)
...
![image-20220408103402882](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408103402882.png)
...
![image-20220408105330635](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408105330635.png)
...
![image-20220407105048696](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220407105048696.png)

这题很明显的提示你使用二分搜索：

![image-20220407105106782](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220407105106782.png)
...
![image-20220416165303983](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220416165303983.png)
...
![image-20220408112432051](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408112432051.png)
...
![image-20220408125219761](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220408125219761.png)
...
![image-20220624085358222](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220624085358222.png)
...
![image-20220409141850203](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409141850203.png)

本题正常来说一般人还真想不到，顺时针应该是这样的：

![image-20220409142428223](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409142428223.png)

本题不允许使用额外空间，就意味着要自己写旋转，这个过程是非常麻烦的，一不小心就会出错。

本题的巧妙解法是**我们可以先将 `n x n` 矩阵 `matrix` 按照左上到右下的对角线进行镜像对称**：

![image-20220409143212195](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409143212195.png)

**然后再对矩阵的每一行进行反转**：

![image-20220409143225605](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409143225605.png)
...
![image-20220409144008220](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409144008220.png)
...
![image-20220409144017241](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220409144017241.png)
...
![image-20220622073144751](https://fastly.jsdelivr.net/gh/Faraway002/typora/images/image-20220622073144751.png)

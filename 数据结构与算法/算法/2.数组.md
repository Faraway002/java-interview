...
![image-20220417135818099](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220417135818099.png)
...
![image-20220417135853417](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220417135853417.png)

本题和上一题类似，快指针探路时碰到了 val，就往前走直到碰到一个非 val 的值为止，然后交换 slow 和 fast 对应的数组值：
...
这题跟上一题区别就在于值固定为 0，且是交换到末尾，那么只要让快指针在碰到 0 时跳过；没碰到 0 时与 slow 交换，然后一起走即可：
...
![image-20220409134141613](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220409134141613.png)
...
![image-20220409144008220](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220409144008220.png)

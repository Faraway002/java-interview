...
![image-20220726100925046](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220726100925046.png)
...
![](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220721095249647.png)

本题要求找到所有字母异位词的起点，字母异位词的要求不仅是字母相同，而且必须是数量相同。

我们继续使用滑动窗口，窗口收缩的条件还要加上一个窗口长度。
...
public List<Integer> findAnagrams(String s, String p) {
    ...
    while (right < s.length()) {
        ...
        if (need.containsKey(cur)) {
      	...
      	// >= 都可以收缩，看这个用例 babac 和 abc，babac 都会在窗口内，但是只有后面的 bac 符合
...
![image-20220721113504376](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220721113504376.png)
...
![image-20220721115916633](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220721115916633.png)
...
![image-20220726100510588](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220726100510588.png)

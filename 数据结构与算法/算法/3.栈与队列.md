...
![image-20220419212619310](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220419212619310.png)

本题限制只能用栈的标准操作。

仔细思考队列的性质，是先进先出。只用一个栈是无法实现这一功能的，必须使用至少两个栈，我们称之为 s1 和 s2。

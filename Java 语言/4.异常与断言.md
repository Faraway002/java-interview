...
![image-20220129122838773](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220129122838773.png)

就是一个堆栈轨迹，异常堆栈轨迹详细的展示了错误发生在哪一行。

通过堆栈轨迹和异常链，我们可以很快定位错误，比如 SpringBoot 应用程序中可能出现的异常，这个堆栈轨迹相当长：

![image-20220129123255532](https://cdn.jsdelivr.net/gh/Faraway002/typora/images/image-20220129123255532.png)
